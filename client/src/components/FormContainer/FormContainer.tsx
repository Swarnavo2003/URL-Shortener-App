  ...
  return (
    <div className="container mx-auto p-2">
      <div className="my-8 rounded-xl bg-cover bg-center">
        <div className="w-full h-full rounded-xl p-20 backdrop-brightness-0">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex">
              <div className="relative w-full">
                ...
                <button
                  type="submit"
                  className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-blue-700 rounded border border-blue-700 focus:right-4 focus:ring-blue-300"
                >
                  Shorten URL
                </button>
              </div>
